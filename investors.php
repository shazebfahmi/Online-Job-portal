...
<body>
  ...
  <div class="navbar1">
    <a>Helpline <i class="fa fa-fw fa-phone"></i> :+91 7892915411</a>
    <a>like us subsribe us in our channel</a>
     ...
     <a  target="_blank" href="https://twitter.com/jobsportal4/"><i class="fa fa-fw fa-twitter"></i></a>
      ...
      <a target="_blank" href="https://www.google.com/"><i class="fa fa-fw fa-google"></i></a>
...
<div class="row">
  <div class="side" style="font-family:'Bauhaus 93'; background-color:#A0AEF7; " >    <h2>ABOUT US</h2>
    ...
    <h5 style="font-family:'Arial Rounded MT Bold';" ><i class="fa fa-angle-double-right"></i>Currently we are holding $1.2 billion shares with funding from LinkedIn and Internshala. </h5>
      ...
      <ul>
        ...
        <li>vedio lectures on cracking interviews</li>
        <li>coding e-books </li>
        <li>Aptitude questins </li>
        <li>every company's previous interview model questions</li>
      </ul>
  ...
  <div class="main">
         ...
         $uperJobsPortal - IPO Registrar</h1>
         <br/>
         <hr/>
           <img src="images/linkdin.png" align="right" height="142" width="512">
           <p>Linkdin,<br />
                C-13 Pannalal Silk Mills Compound,<br />
                LBS Marg, Bhandup West, Mumbai 400078 <br />

Phone: +91-22-25963838 <br>

Fax: +91-22-25946969,<br/>

Email: e2e.ipo@linkintime.co.in<br />

Website: http://www.linkdin.co.in</p>
...
<img src="images/internshala.png" align="right" height="122" width="312">
<p>Internsala private co lmt,<br />
  401-405 & 416-418, 4th Floor, Soni paris Point

Jai Singh Highway, Banipark Jaipur-302016 <br />

Tel. No: +91-141-2203995, +91-141-2201259 <br />

Email: info@holaniconsultants.co.in <br />

Website: http://www.holaniconsultants.co.in</p> <hr/>
</div>
</div>
...
<p>Posted by: Admin@$uperTeam </br>
 #77,7th block 3rd main road behind BDA COMPLEX,nagarabhavi bengaluru 560056 </br>
  ...
  � Copyright 2019 www.$uperjobsportal.com. All rights reserved. Developed by $uperTeam.
</p>
</div>
