	...
	if(isset($_POST['login_btn']))
		{
			...
			$query = "select * from admin where auname = '$username' AND apasswd='$password'";
			...
			{
				echo '<script type="text/javascript"> alert("The username or password did not match our database")</script>';
			}
		}
...
<div class="row">
	...
	<div class="main" id="main-wrapper" >
		<center><h2>Enter your Admin credentials</h2>
		<img src="images/man.png" class="imageppt">
		</center>
		<form  method ="post" class="myform" ><center>
			...
			<input name="login_btn" type="submit"  id ="signupbtn" value="Login" style="width:40%;" ><br><br>
			<br></center>
			</form>
	</div>
