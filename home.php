...
<div class="row">
  ...
  <div class="main">
    <h2 "color:#0099ff">WELCOME TO GET EMPLOYED HERE!!!!</h2>
    <h5>A platform where we bridge the gap to find your ideal Job.</h5>
     <img src="images/home.jpg" height="242" width="842">
    <p>We Cordially invite one and all to use our portal by joining hands with our motto and make best use of it, to uproot unemployement throughout the Nation.</p>
    <br>
    <h2>COMPANIES WHICH HAS TIED UP WITH US</h2>
    <h5>Here Are Our Leading Job Providers Through Our Portal</h5>
     <img src="images/company.jpg" height="242" width="842">
    <p>Please subscribe to our pages on various social media platforms. Also please free to ask any queries regarding this portal with our helpline.</p><br/>
    <p>Also U can Contact our Admins through WhatsApp by clicking on WhatsApp link on top of the navigation bar</p>
   </div>
</div>
...
<p>Posted by: Admin@$uperTeam</br>
 #77,7th block 3rd main road behind BDA COMPLEX,nagarabhavi bengaluru 560056 </br>
   Contact information: aliasing126@gmail.com <hr size="5pt"   color="white"/>
