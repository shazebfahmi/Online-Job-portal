<?php
	...
	if(isset($_POST['but']))
	{
		...
		$query66 = "select * from employee where euname='$user' and epasswd='$passwd'";
		$res = mysqli_query($con,$query66);

		if(mysqli_num_rows($res)>0)
		{
			//echo '<script> alert("employee username and passwd matched the database ")</script>';
			$_SESSION['name']=$user;
			header('location:employeepage.php');
		}
		else
		{
			echo '<script> alert("employee username and passwd did not match the database ")</script>';
		}
	}
?>
...
<div class="row">
	...
	<div class="main" id="main-wrapper" >
		<center><h2>Enter your Employee credentials</h2>
		<img src="images/women.png" class="imageppt">
		</center>

		<form  method ="post" class="myform"><center>
			<label><b><br><br>Username: </b></label><br>
			...
			<input name = "but" type="submit"  id ="signupbtn" value="Login" style="width:35%;"><br><br>
			<a href="employeeregister.php"><label style="backgroung-color:#0093FF; font-weight:bold; "><b>Not registered yet? Register Now </b></label><br></a><br>
